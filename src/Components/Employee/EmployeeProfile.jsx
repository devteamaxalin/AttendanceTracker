...
//                   <input type="text" name="department" value={profile.department} style={{ ...styles.input, ...styles.disabledInput }} disabled />
//                 </div>
//               </div>
...
//                   <input type="text" name="role" value={profile.role} style={{ ...styles.input, ...styles.disabledInput }} disabled />
//                 </div>
//               </div>
//             </div>
...
//   disabledInput: { backgroundColor: '#f8fafc', borderColor: '#e2e8f0', color: '#94a3b8', cursor: 'not-allowed' },
