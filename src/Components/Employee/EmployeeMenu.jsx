...
import { LuLayoutDashboard, LuCalendarDays, LuClock, LuUser, LuLogOut , LuClipboardCheck } from 'react-icons/lu';
...
export default function EmployeeMenu({ onLogout }) {
  ...
  return (
    <aside style={styles.sidebar}>
      ...
      <NavLink to="/employee/attendance" style={getNavLinkStyle}>
        <LuClipboardCheck style={styles.icon} /> Check In / Check Out
      </NavLink>
